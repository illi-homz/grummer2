...
grummer.store = {
  ...
  breeds: [
    ...
    { title: "Шпиц малый", value: "shpits-mall", type: "dog" },
    { title: "Шпиц японский", value: "shpits-japan", type: "dog" },
    { title: "Шпиц карликовый (померанский)", value: "shpits-king", type: "dog" },
    { title: "Ши-Тцу", value: "shi-tsy", type: "dog" },
    { title: "Норвич-терьер", value: "norvich-terier", type: "dog" },
    { title: "Норфолк-терьер", value: "norfolk-terier", type: "dog" },
    { title: "Миттельшнауцер", value: "mittelshnatser", type: "dog" },
    { title: "Японский хин", value: "japan-hin", type: "dog" },
    { title: "Русская цветная болонка", value: "rus-color-balonka", type: "dog" },
    {
    ...
    { title: "Русский охотничий спаниель", value: "rus-spaniel", type: "dog" },
    {
    ...
    { title: "Бульдог Французский", value: "buldog-franch", type: "dog" },
    ...
    { title: "Пудель большой", value: "pudel-big", type: "dog" },
    { title: "Русский той-терьер", value: "rus-toi", type: "dog" },
    {
    ...
    { title: "Фокстерьер жескошерстный", value: "foxterier-hardhair", type: "dog" },
    { title: "Гриффон (брюсельский, бельгийский)", value: "griffon", type: "dog" },
    {
      title: "Золотистый ретривер (голден)",
      value: "gold-retriver",
      type: "dog",
    },
    { title: "Алабай (средне-азиатская овчарка)", value: "alabai", type: "dog" },
    { title: "Бордер колли", value: "killi", type: "dog" },
    { title: "Вест-хайленд-вайт-терьер", value: "vest-hilend", type: "dog" },
    ...
    { title: "Сиба-ину", value: "siba-inu", type: "dog" },
    { title: "Скотч-терьер", value: "scotch-terier", type: "dog" },
    { title: "Силихем-терьер", value: "silihem-terier", type: "dog" },
    { title: "Грифон", value: "grifon", type: "dog" },
    { title: "Такса гладкошерстная", value: "taksa", type: "dog" },
    { title: "Такса жесткошерстная", value: "taksa-hard", type: "dog" },
    { title: "Такса длинношерстная", value: "taksa-longhair", type: "dog" },
    ...
    { title: "Ирландский мягкошерстный пшеничный терьер", value: "ireland-terier-soft", type: "dog" },
    { title: "Немецкая овчарка", value: "deutsch-ovcharka", type: "dog" },
    { title: "Пиренейская овчарка", value: "pireneiskaya-ovcharka", type: "dog" },
