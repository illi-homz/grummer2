...
grummer.popupMain = {
  open(title, rewriteUl = true) {
    ...
    const html = template.replace(/{{title}}/ig, service.title).replace(/{{price}}/ig, service.price);
...
grummer.popupServices = {
  init() {
    ...
    this.setSlides(grummer.servicesList.filter(el => el.category !== 'add-services'), this.sliderList, this.sliderTemplate);
    this.setSlides(grummer.servicesList.filter(el => el.category === 'add-services'), this.sliderListAdd, this.sliderTemplateAdd);
  ...
  filterServicesByCategory(val) {
    !val ? this.filter(grummer.servicesList.filter(el => el.category !== 'add-services')) : this.filter(this.filterServices(val, 'category'));
  },
